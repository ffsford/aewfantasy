...
function renderStandings() {
  ...
  if (notice) {
    if (data.nextPurgeAt || data.nextPurgeDate) {
      ...
      notice.innerHTML = `<span class="text-red-400 font-bold">PURGE</span> auto-runs <strong>${label}</strong>${data.purgeNotes ? ' — ' + data.purgeNotes : ''}. Last place in each division is removed; rosters go to free agency.`;
