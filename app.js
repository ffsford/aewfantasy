...
function renderClaimList() {
  ...
  if (claimRanked.length === 0) {
    el.innerHTML = '<p class="text-sm text-gray-500 text-center py-6">Tap wrestlers you want (one is fine; more = priority order if your first choices are taken). Drag names to change order.</p>';
  } else {
